 ...
 * 
 */
package codility.futureprogramming;
...
public class ArrayInversionCount {
	/*
	 * A zero-indexed array A consisting of N integers is given. An inversion is
	 * a pair of indexes (P, Q) such that P < Q and A[Q] < A[P].
	 * 
	 * Write a function:
	 * 
	 ...
	 * an integer within the range [−2,147,483,648..2,147,483,647]. For example,
